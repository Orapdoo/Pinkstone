...
public class ChunkRenderList {
    ...
    private final ByteArrayIterator sectionsWithSpritesIterator = new ByteArrayIterator(this.sectionsWithSprites, 0);

    private final byte[] sectionsWithEntities = new byte[RenderRegion.REGION_SIZE];
    private int sectionsWithEntitiesCount = 0;
    private final ByteArrayIterator sectionsWithEntitiesIterator = new ByteArrayIterator(this.sectionsWithEntities, 0);

    private final ReversibleByteArrayIterator sectionsWithGeometryForwardIterator = new ReversibleByteArrayIterator(this.sectionsWithGeometry, 0, false);
    private final ReversibleByteArrayIterator sectionsWithGeometryReverseIterator = new ReversibleByteArrayIterator(this.sectionsWithGeometry, 0, true);
    ...
    private final int[] sortingHistogram = new int[SORTING_HISTOGRAM_SIZE];
    ...
    private void sortSections(int relativeCameraSectionX, int relativeCameraSectionY, int relativeCameraSectionZ, SortItemsProvider sortItemsProvider) {
        ...
        int[] histogram = this.sortingHistogram;
    ...
    public @Nullable ByteIterator sectionsWithGeometryIterator(boolean reverse) {
        ...
        return reverse
                ? this.sectionsWithGeometryReverseIterator.reset(this.sectionsWithGeometryCount)
                : this.sectionsWithGeometryForwardIterator.reset(this.sectionsWithGeometryCount);
    }
    ...
    public @Nullable ByteIterator sectionsWithSpritesIterator() {
        ...
        return this.sectionsWithSpritesIterator.reset(this.sectionsWithSpritesCount);
    }
    ...
    public @Nullable ByteIterator sectionsWithEntitiesIterator() {
        ...
        return this.sectionsWithEntitiesIterator.reset(this.sectionsWithEntitiesCount);
    }
