...
public abstract class SectionCollector implements RenderListProvider, RenderSectionVisitor {
    private int frame;
    private TaskQueueType importantRebuildQueueType;
    private TaskQueueType importantSortQueueType;
    ...
    public SectionCollector(int frame, TaskQueueType importantRebuildQueueType, TaskQueueType importantSortQueueType) {
        ...
        this.reset(frame, importantRebuildQueueType, importantSortQueueType);
    }

    public void reset(int frame, TaskQueueType importantRebuildQueueType, TaskQueueType importantSortQueueType) {
        this.frame = frame;
        ...
        for (var queue : this.sortedTaskLists.values()) {
            queue.clear();
        }
    }
